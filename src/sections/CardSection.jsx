  ...
  return (
    <StyledSection>
      <CardComponents
        hasButton={false}
        title="Internship"
        image="src/assets/card_image/product-internship.svg"
      ...
      <CardComponents
        ...
        title="Certification"
        image="src/assets/card_image/product-certification..svg"
      ...
      <CardComponents
        ...
        buttonText="Optional"
        title="Bootcamp"
        image="src/assets/card_image/product-bootcamp.svg"
